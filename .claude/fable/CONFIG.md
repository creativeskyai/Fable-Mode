...
lower round and lead caps. **standard** = the shipped defaults. **max** = 5-vote
verification and raised caps, for audits.
...
|---|---|---|---|
| `value` (the default) | Fable 5 @ low effort, or Opus 5 | opus @ medium | standard |
| `light` | anything | inherit @ low | light |
